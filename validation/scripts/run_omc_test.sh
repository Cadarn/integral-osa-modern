#!/usr/bin/env bash
# ==============================================================================
# validation/scripts/run_omc_test.sh
#
...
WORK_IN="${5:-$PROJECT_ROOT/validation_runs/omc}"
mkdir -p "$WORK_IN"
WORK_DIR="$(cd "$WORK_IN" && pwd)"

echo "===================================================================="
echo " INTEGRAL OSA Modern: OMC Official Testdata Validation"
echo "===================================================================="
...
echo ""
echo ">>>>> OMC analysis finished in ${ELAPSED} seconds."
