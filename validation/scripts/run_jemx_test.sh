#!/usr/bin/env bash
# ==============================================================================
# validation/scripts/run_jemx_test.sh
#
...
WORK_IN="${5:-$PROJECT_ROOT/validation_runs/jemx}"
mkdir -p "$WORK_IN"
WORK_DIR="$(cd "$WORK_IN" && pwd)"

echo "===================================================================="
echo " INTEGRAL OSA Modern: JEM-X 2 Official Testdata Validation"
echo "===================================================================="
...
docker run --rm \
    ...
    bash -c "
        ...
        jemx_science_analysis \
            jemxNum=2 \
            ogDOL='og_jmx2.fits[1]' \
            startLevel='COR' \
            endLevel='IMA2' \
            skipLevels='BIN_S,BIN_T' \
            IMA_skyImagesOut='RECONSTRUCTED,VARIANCE,DEVEL,TRACE'
    "
...
echo ""
echo ">>>>> JEM-X 2 analysis finished in ${ELAPSED} seconds."
